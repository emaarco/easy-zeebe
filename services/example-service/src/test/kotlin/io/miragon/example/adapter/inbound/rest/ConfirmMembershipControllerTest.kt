...
@WebMvcTest(ConfirmMembershipController::class)
class ConfirmMembershipControllerTest {

    @Autowired
    private lateinit var mockMvc: MockMvc

    @MockkBean
    private lateinit var useCase: ConfirmMembershipUseCase

    @Test
    fun `user confirms membership`() {
        ...
        val operation = post("/api/memberships/confirm/{membershipId}", pathVar)
        ...
        verify { useCase.confirm(MembershipId(pathVar)) }

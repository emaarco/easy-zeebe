...
class NewsletterSubscriptionProcessAdapterTest {
    ...
    // Stub with any(), assert returned key, verify with named args using ProcessApi constants.
    // End with confirmVerified to catch unexpected interactions.
    @Test
    ...
    // --- sendMessage variant ---
    // Stub with just Runs; verify messageName, correlationId, and variables with named args.
    @Test

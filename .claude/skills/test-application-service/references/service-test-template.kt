...
// Pure mockk unit test — no Spring context.
// Multiple mockk<>() dependencies, named constructor args.
// slot<T> to capture arguments passed to Unit-returning methods.
class SubscribeToNewsletterServiceTest {
    ...
    fun `create subscription`() {
        ...
        // slot captures the argument passed to a Unit-returning method (just Runs)
        ...
        // confirmVerified lists all mocks to detect unexpected interactions
